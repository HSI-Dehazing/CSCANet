...
class MyDataset(Dataset):
    def __init__(self, im_list_x, im_list_y, loader=default_loader, exchange_bands=True, first_branch_channel=66):
...
im_train_list_x = glob.glob("./dataset/HSIDeD-AVI/train/hazy/*.mat")
im_train_list_y = glob.glob("./dataset/HSIDeD-AVI/train/clean/*.mat")
im_test_list_x = glob.glob("./dataset/HSIDeD-AVI/test/hazy/*.mat") #视情况切换为验证集 
im_test_list_y = glob.glob("./dataset/HSIDeD-AVI/test/clean/*.mat") #视情况切换为验证集 
